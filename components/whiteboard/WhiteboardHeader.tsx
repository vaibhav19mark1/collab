...
export const WhiteboardHeader = ({
  ...
  return (
    <div className="h-16 border-b flex items-center justify-between px-4 bg-background/95 backdrop-blur supports-backdrop-filter:bg-background/60 z-50 relative">
